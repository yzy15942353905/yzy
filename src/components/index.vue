 ...
 * @LastEditTime: 2023-02-10 09:11:51
...
<template>
  <div>
    ...
    <el-row :gutter="10">
      <el-col :span="12">
        <div id="StackedCharts" style="height: 400px"></div>
      </el-col>
      <el-col :span="12">
        <div id="PieCharts" style="height: 400px"></div>
      </el-col>
    </el-row>
  </div>
</template>
...
export default {
  methods: {
    ...
    drawStackedLine() {
      var chartDom = document.getElementById("StackedCharts");
